...
#define CF_AVAILABLE(_mac, _ios) __attribute__((weak_import,deprecated("API newer than Deployment Target.")))
#define CF_AVAILABLE_MAC(_mac) __attribute__((availability(macosx,introduced=_mac)))
#define CF_AVAILABLE_IOS(_ios) __attribute__((weak_import,deprecated("API newer than Deployment Target.")
